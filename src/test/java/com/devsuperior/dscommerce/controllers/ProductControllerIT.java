...
import com.devsuperior.dscommerce.factory.TokenUtil;
...
public class ProductControllerIT {
    ...
    void setUp() throws Exception {
        ...
        invalidToken = "invalid.token.here"; // simulates wrong password

        Category category = new Category();
        category.setId(2L);
        category.setName("Digital Electronics");
        product = new Product();
        product.setName(productName);
        product.setDescription("Macbook Pro Description");
        product.setPrice(1250.0);
        product.setImgUrl("https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/3-big.jpg");
    ...
    public void insertShouldReturnProductDTOCreatedWhenAdminLogged() throws Exception {
        ...
        result.andExpect(jsonPath("$.id").value(26L)); // total de 25 elementos, por isso esse seria o 26
        result.andExpect(jsonPath("$.name").value("Macbook"));
        ...
        result.andExpect(jsonPath("$.description").value("Macbook Pro Description"));
    ...
    @Test
    public void insertShouldReturnUnprocessableEntityWhenAdminLoggedAndProductHasNotCatedory() throws Exception {
    ...
    public void deleteShouldReturnConflictWhenIdExistsAndAdminLogged() throws Exception {
